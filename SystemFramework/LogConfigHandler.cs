namespace HiRes.SystemFramework.Logging {
	...
	///     </remarks>
	/// </summary>
	public class LogConfiguration : IConfigurationSectionHandler {

		//
		// Constant values for all of the SystemFramework standard settings
		//
		private const String TRACING_ENABLED = "AppLog.Tracing.Enabled";
		private const String TRACING_TRACEFILE = "AppLog.Tracing.TraceFile";
		private const String TRACING_TRACELEVEL = "AppLog.Tracing.TraceLevel";
		private const String TRACING_SWITCHNAME = "AppLog.Tracing.SwitchName";
		private const String TRACING_SWITCHDESCRIPTION = "AppLog.Tracing.SwitchDescription";
		private const String EVENTLOG_ENABLED = "AppLog.EventLog.Enabled";
		private const String EVENTLOG_MACHINENAME = "AppLog.EventLog.Machine";
		private const String EVENTLOG_SOURCENAME = "AppLog.EventLog.SourceName";
		private const String EVENTLOG_TRACELEVEL = "AppLog.EventLog.LogLevel";
		...
		private const String TRACING_TRACEFILE_DEFAULT = "traceInfo.txt";
		...
		public Object Create(Object parent, object configContext, XmlNode section) {
			...
			NameValueCollection logSetings;
            String isWorks = "init";
			try {
				NameValueSectionHandler baseHandler = new NameValueSectionHandler();
				logSetings = (NameValueCollection)baseHandler.Create(parent, configContext, section);
			}
			catch {
				logSetings = null;
			}
			...
			if (logSetings == null) {
				...
				isWorks = "begin reading";
				tracingEnabled = ReadSetting(logSetings, TRACING_ENABLED, TRACING_ENABLED_DEFAULT);
				tracingTraceFile = ReadSetting(logSetings, TRACING_TRACEFILE, TRACING_TRACEFILE_DEFAULT);
				tracingTraceLevel = ReadSetting(logSetings, TRACING_TRACELEVEL, TRACING_TRACELEVEL_DEFAULT);
				tracingSwitchName = ReadSetting(logSetings, TRACING_SWITCHNAME, TRACING_SWITCHNAME_DEFAULT);
				tracingSwitchDescription = ReadSetting(logSetings, TRACING_SWITCHDESCRIPTION, TRACING_SWITCHDESCRIPTION_DEFAULT);
				eventLogEnabled = ReadSetting(logSetings, EVENTLOG_ENABLED, EVENTLOG_ENABLED_DEFAULT);
				eventLogMachineName = ReadSetting(logSetings, EVENTLOG_MACHINENAME, EVENTLOG_MACHINENAME_DEFAULT);
				eventLogSourceName = ReadSetting(logSetings, EVENTLOG_SOURCENAME, EVENTLOG_SOURCENAME_DEFAULT);
				eventLogTraceLevel = ReadSetting(logSetings, EVENTLOG_TRACELEVEL, EVENTLOG_TRACELEVEL_DEFAULT);
			}
		...
		/// </summary>
		public static TraceLevel ReadSetting(NameValueCollection logSetings, String key, TraceLevel defaultValue) {
			try {
				Object setting = logSetings[key];
		...
		public static void OnApplicationStart(String myAppPath) {
			...
			appRoot = myAppPath;
			System.Configuration.ConfigurationSettings.GetConfig("AppLogConfiguration");
